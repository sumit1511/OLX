...
public class user_pending_MyAdapter extends RecyclerView.Adapter<user_pending_MyAdapter.MyViewHolder> {

    Context context;
    ArrayList<Item> profiles;

    public user_pending_MyAdapter(Context c , ArrayList<Item> p)
    {
        context = c;
        profiles = p;
    }
